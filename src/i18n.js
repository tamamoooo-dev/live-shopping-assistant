...
const STRINGS = {
  en: {
    ...
    'watch.searchQuery': 'Search phrase (optional)',
    'watch.searchPlaceholder': 'Example: Nadec milk',
    'watch.searchHint': 'Leave blank to use the automatic general product + brand phrase.',
  ...
  ar: {
    ...
    'watch.searchQuery': 'كلمة البحث (اختياري)',
    'watch.searchPlaceholder': 'مثال: حليب نادك',
    'watch.searchHint': 'اتركه فارغًا لاستخدام عبارة المنتج العام + العلامة التي ينشئها النظام.',
