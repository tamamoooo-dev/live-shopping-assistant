...
const STRINGS = {
  en: {
    ...
    'browse.brandStats': '{offers} flyer offers · {stores} stores this week',
    'browse.brandFlyerCount': '{count} flyer offers',
    'browse.flyerOffers': 'This week’s flyer offers',
    'browse.flyerLead': 'Structured offers found in current supermarket flyers.',
    'browse.onlineOffers': 'Products from online stores',
    'browse.onlineLead': 'Live results from online stores are searched when you open this brand and counted separately from flyers.',
    ...
    'alerts.lead': 'Two checks every day at 07:00 and 19:00 Riyadh time. Failed access retries every minute.',
    ...
    'alerts.noneWatchedHint':
      'Search for a product, then use “🔔 Watch price”. Amazon-linked products stay exact; everything else searches all sources by product + brand.',
    ...
    'alerts.closePrice': '● Close price',
    'alerts.checkingDaily': 'Checks at 07:00 and 19:00…',
    'alerts.retrying': '↻ Access failed — retrying every minute (attempt {attempt})',
    'alerts.retryingShort': 'Retrying access every minute…',
    // A watch with no product anchor is NOT "still watching" — it is not
    // watching at all. Saying so plainly is the point of the redesign.
    'alerts.needsConfirmation': '? Needs your confirmation',
    'alerts.resolving': 'Finding the exact product…',
    'alerts.notWatching': '! Not watching yet',
    'alerts.unresolvable': "! Can't identify this product",
    'alerts.pendingMigration': 'Waiting to be linked to a product',
    'alerts.resolvingPrice': 'Identity resolution in progress',
    'alerts.confirmCta': 'Choose the product',
    'alerts.confirmTitle': 'Which product is this?',
    'alerts.confirmNone': 'No matching products found.',
    'alerts.confirmNoneAction': 'None of these',
    'alerts.confirmLater': 'Decide later',
    'alerts.confirmed': 'Linked — monitoring resumes on the next check.',
    'alerts.diagnoseCta': 'Why is this quiet?',
    'alerts.diagnoseTitle': 'What the last look found',
    'alerts.diagnoseSummary': '{seen} candidates seen, {matched} matched.',
    ...
    'alerts.scopeCategory': 'All sources · general product + brand',
    'alerts.target': 'target {price}',
    'alerts.closeWithin': 'close within {percent}%',
    'alerts.checkedAt': 'checked {date}',
    'alerts.firstCheck': 'next check at 07:00 or 19:00',
    ...
    'alerts.closeHit': '{label} is close at {price}',
    ...
    'watch.hintProduct':
      'The exact Amazon ASIN is checked at 07:00 and 19:00. If it cannot be reached, access retries every minute.',
    'watch.hintGrocery':
      'The product is generalized to product + brand and checked in every source, including Amazon, at 07:00 and 19:00.',
    'watch.rowLabel': 'Alert me at or below (SAR)',
    'watch.currentBest': 'Current best: {price}',
    'watch.advanced': 'Advanced',
    'watch.searchQuery': 'Exact search phrase (optional)',
    'watch.searchPlaceholder': 'Example: Nadec milk',
    'watch.searchHint': 'When entered, every word and stated size must match the result. Leave blank to use the automatic general product + brand phrase.',
    'watch.matchBrand': 'Match Brand',
    'watch.matchSize': 'Match Size',
    'watch.matchVariant': 'Match Variant',
    'watch.closeThreshold': 'Close price threshold (%)',
    'watch.closePlaceholder': 'Optional, e.g. 10',
    'watch.unitPriceHint': 'Different package sizes will be compared by unit price.',
    'watch.categoryHint': 'Category-level watch: all brands, sizes, and variants. Unit price is used.',
    'watch.saveSettings': 'Save settings',
    'watch.updateError': 'Could not update this watch right now.',
    'watch.cancel': 'Cancel',
    ...
    'enrichment.medium': 'Enriched with Medium',
    'enrichment.enriched': 'Enriched',
    'enrichment.missing': 'Not enriched',
    'discountDot.low': '{percent}% discount — under 15%',
    'discountDot.mid': '{percent}% discount — 15% to 45%',
    'discountDot.high': '{percent}% discount — over 45%',
    ...
    'viewer.zoomMode': 'Zoom',
    'viewer.zoomModeHint': 'Read this page one product at a time, enlarged',
    'viewer.zoomPrev': 'Previous product',
    'viewer.zoomNext': 'Next product',
    ...
    'sheet.noteUnpriced': 'No machine-read price for this product — see the flyer page for its price.',
    'sheet.priceOnFlyer': 'Price on the flyer',
    'sheet.verify': 'Verify ↗',
  ...
  ar: {
    ...
    'browse.brandStats': '{offers} عرضًا في النشرات · {stores} متاجر هذا الأسبوع',
    'browse.brandFlyerCount': '{count} عرضًا في النشرات',
    'browse.flyerOffers': 'عروض نشرات هذا الأسبوع',
    'browse.flyerLead': 'العروض المنظمة التي عُثر عليها في نشرات السوبرماركت الحالية.',
    'browse.onlineOffers': 'منتجات المتاجر الإلكترونية',
    'browse.onlineLead': 'يتم البحث المباشر في المتاجر الإلكترونية عند فتح البراند، ويُحتسب عددها بشكل مستقل عن النشرات.',
    ...
    'alerts.lead': 'فحصان يوميًا عند 07:00 و19:00 بتوقيت الرياض، مع إعادة محاولة الوصول كل دقيقة عند الفشل.',
    ...
    'alerts.noneWatchedHint':
      'ابحث عن منتج ثم استخدم «🔔 متابعة السعر». منتج أمازون المرتبط يبقى مطابقًا تمامًا، وما عداه يُبحث عنه في كل المصادر باسم المنتج والعلامة.',
    ...
    'alerts.closePrice': '● السعر قريب',
    'alerts.checkingDaily': 'الفحص عند 07:00 و19:00…',
    'alerts.retrying': '↻ تعذّر الوصول — إعادة المحاولة كل دقيقة (المحاولة {attempt})',
    'alerts.retryingShort': 'نعيد محاولة الوصول كل دقيقة…',
    'alerts.needsConfirmation': '؟ بحاجة إلى تأكيدك',
    'alerts.resolving': 'جارٍ العثور على المنتج الدقيق…',
    'alerts.notWatching': '! المتابعة لم تبدأ بعد',
    'alerts.unresolvable': '! تعذّر تحديد هذا المنتج',
    'alerts.pendingMigration': 'بانتظار الربط بمنتج',
    'alerts.resolvingPrice': 'جارٍ التحقق من هوية المنتج',
    'alerts.confirmCta': 'اختر المنتج',
    'alerts.confirmTitle': 'أي منتج هذا؟',
    'alerts.confirmNone': 'لم يتم العثور على منتجات مطابقة.',
    'alerts.confirmNoneAction': 'لا شيء من هذه',
    'alerts.confirmLater': 'القرار لاحقًا',
    'alerts.confirmed': 'تم الربط — تستأنف المتابعة في الفحص القادم.',
    'alerts.diagnoseCta': 'لماذا لا توجد نتائج؟',
    'alerts.diagnoseTitle': 'ما وجده الفحص الأخير',
    'alerts.diagnoseSummary': 'تم فحص {seen} منتجًا، تطابق {matched}.',
    'alerts.diagnoseFailed': 'تعذّر الفحص الآن.',
    'alerts.repairCta': 'محاولة الإصلاح',
    'alerts.repairing': 'جارٍ التحقق من الهوية…',
    'alerts.atStore': 'في {store}',
    'alerts.flyerSuffix': ' (نشرة)',
    'alerts.scopeProduct': '{store} · هذا المنتج',
    'alerts.scopeAll': 'كل المتاجر + النشرات',
    'alerts.scopeCategory': 'كل المصادر · المنتج العام + العلامة',
    'alerts.target': 'المستهدف {price}',
    'alerts.closeWithin': 'قريب ضمن {percent}٪',
    'alerts.checkedAt': 'فُحص {date}',
    'alerts.firstCheck': 'الفحص القادم عند 07:00 أو 19:00',
    ...
    'alerts.closeHit': 'اقترب {label} من الهدف عند {price}',
    ...
    'watch.hintProduct':
      'يُفحص ASIN أمازون نفسه عند 07:00 و19:00. عند تعذّر الوصول إليه تُعاد المحاولة كل دقيقة.',
    'watch.hintGrocery':
      'يُعمّم المنتج إلى اسم المنتج والعلامة، ثم يُفحص في كل المصادر ومنها أمازون عند 07:00 و19:00.',
    'watch.rowLabel': 'نبّهني عند هذا السعر أو أقل (ريال)',
    'watch.currentBest': 'أفضل سعر حالي: {price}',
    'watch.advanced': 'متقدم',
    'watch.searchQuery': 'عبارة البحث الدقيقة (اختياري)',
    'watch.searchPlaceholder': 'مثال: حليب نادك',
    'watch.searchHint': 'عند كتابتها يجب أن تطابق النتيجة كل كلماتها والحجم المذكور. اتركها فارغة لاستخدام المنتج العام + العلامة.',
    'watch.matchBrand': 'مطابقة العلامة التجارية',
    'watch.matchSize': 'مطابقة الحجم',
    'watch.matchVariant': 'مطابقة النوع',
    'watch.closeThreshold': 'حد السعر القريب (٪)',
    'watch.closePlaceholder': 'اختياري، مثال 10',
    'watch.unitPriceHint': 'ستتم مقارنة أحجام العبوات المختلفة بسعر الوحدة.',
    'watch.categoryHint': 'متابعة على مستوى الفئة: كل العلامات والأحجام والأنواع، باستخدام سعر الوحدة.',
    'watch.saveSettings': 'حفظ الإعدادات',
    'watch.updateError': 'تعذر تحديث المتابعة الآن.',
    'watch.cancel': 'إلغاء',
    ...
    'enrichment.medium': 'تم الإثراء بواسطة Medium',
    'enrichment.enriched': 'تم الإثراء',
    'enrichment.missing': 'غير مُثرى',
    'discountDot.low': 'خصم {percent}% — أقل من 15%',
    'discountDot.mid': 'خصم {percent}% — من 15% إلى 45%',
    'discountDot.high': 'خصم {percent}% — أكثر من 45%',
    ...
    'viewer.zoomIn': 'تكبير',
    'viewer.zoomMode': 'تكبير',
    'viewer.zoomModeHint': 'اقرأ هذه الصفحة منتجًا واحدًا في كل مرة، بحجم أكبر',
    'viewer.zoomPrev': 'المنتج السابق',
    'viewer.zoomNext': 'المنتج التالي',
    ...
    'sheet.noteUnpriced': 'لا يوجد سعر مقروء آليًا لهذا المنتج — راجع صفحة النشرة لمعرفة سعره.',
    'sheet.priceOnFlyer': 'السعر في النشرة',
    'sheet.verify': 'تحقّق ↗',
