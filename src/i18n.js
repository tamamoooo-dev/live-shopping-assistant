...
const STRINGS = {
  en: {
    ...
    'viewer.spotsHint': '{count} products on this page — tap one for price & cart',
  ...
  ar: {
    ...
    'viewer.spotsHint': '{count} منتجات في هذه الصفحة — اضغط أحدها للسعر والسلة',
