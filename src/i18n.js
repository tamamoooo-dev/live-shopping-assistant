...
const STRINGS = {
  en: {
    ...
    'search.storesGroupLabel': 'Stores to search',
    'search.allStores': 'All stores',
    'search.needOneStore': 'Select at least one store to search.',
    'search.searching.one': 'Searching {count} store…',
    'search.searching.other': 'Searching {count} stores…',
    'search.results.one': '{total} result across {stores} for “{q}”',
    'search.results.other': '{total} results across {stores} for “{q}”',
    'search.storesInline.one': '{count} store',
    'search.storesInline.other': '{count} stores',
    ...
    'browse.rail.exceptional': 'Exceptional deals',
    'browse.rail.drops': 'Biggest drops',
    'browse.rail.lowest-ever': 'Lowest ever',
    'browse.rail.ending-soon': 'Ending soon',
    'browse.rail.new-this-week': 'New this week',
    ...
    'market.sortedPrice': 'Best matches • sorted by lowest price',
    ...
    'summary.excl.stage.one':
      '{count} weaker match excluded — the comparison only considers the results that match your search best.',
    'summary.excl.stage.other':
      '{count} weaker matches excluded — the comparison only considers the results that match your search best.',
    'summary.excl.family.one': '{count} similar-name product from a different category excluded from this comparison.',
    'summary.excl.family.other': '{count} similar-name products from a different category excluded from this comparison.',
    'summary.excl.type.one': '{count} product of a different type excluded from this comparison.',
    'summary.excl.type.other': '{count} products of a different type excluded from this comparison.',
    'summary.excl.fresh.one':
      '{count} frozen/processed or flavoured variant excluded — prices compare the fresh product (add e.g. "مجمد" to your search to compare those instead).',
    'summary.excl.fresh.other':
      '{count} frozen/processed or flavoured variants excluded — prices compare the fresh product (add e.g. "مجمد" to your search to compare those instead).',
    'summary.excl.identity.one':
      '{count} cheaper look-alike from a different brand or variant excluded — prices are compared only for the product identified above.',
    'summary.excl.identity.other':
      '{count} cheaper look-alikes from a different brand or variant excluded — prices are compared only for the product identified above.',
  ...
  ar: {
    ...
    'search.submit': 'بحث',
    'search.storesGroupLabel': 'المتاجر المطلوب البحث فيها',
    'search.allStores': 'كل المتاجر',
    'search.needOneStore': 'اختر متجرًا واحدًا على الأقل للبحث.',
    'search.searching.one': 'جارٍ البحث في {count} متجر…',
    'search.searching.other': 'جارٍ البحث في {count} متجر…',
    'search.results.one': '{total} نتيجة في {stores} عن «{q}»',
    'search.results.other': '{total} نتيجة في {stores} عن «{q}»',
    'search.storesInline.one': 'متجر واحد',
    ...
    'market.sortedPrice': 'أفضل المطابقات • مرتبة حسب الأقل سعرًا',
    ...
    'summary.excl.stage.one': 'استُبعدت مطابقة أضعف — تعتمد المقارنة فقط النتائج الأكثر مطابقةً لبحثك.',
    'summary.excl.stage.other': 'استُبعدت {count} مطابقات أضعف — تعتمد المقارنة فقط النتائج الأكثر مطابقةً لبحثك.',
    'summary.excl.family.one': 'استُبعد {count} منتج بأسماء متشابهة من فئة مختلفة عن هذه المقارنة.',
    'summary.excl.family.other': 'استُبعد {count} منتجات بأسماء متشابهة من فئة مختلفة عن هذه المقارنة.',
    'summary.excl.type.one': 'استُبعد {count} منتج من نوع مختلف عن هذه المقارنة.',
    'summary.excl.type.other': 'استُبعد {count} منتجات من نوع مختلف عن هذه المقارنة.',
    'summary.excl.fresh.one':
      'استُبعد {count} صنف مجمّد/مصنّع أو منكّه — الأسعار تقارن المنتج الطازج (أضف مثلًا «مجمد» إلى بحثك لمقارنة تلك).',
    'summary.excl.fresh.other':
      'استُبعد {count} أصناف مجمّدة/مصنّعة أو منكّهة — الأسعار تقارن المنتج الطازج (أضف مثلًا «مجمد» إلى بحثك لمقارنة تلك).',
    'summary.excl.identity.one':
      'استُبعد {count} منتج شبيه أرخص من علامة أو صنف مختلف — تُقارن الأسعار فقط للمنتج المحدَّد أعلاه.',
    'summary.excl.identity.other':
      'استُبعد {count} منتجات شبيهة أرخص من علامة أو صنف مختلف — تُقارن الأسعار فقط للمنتج المحدَّد أعلاه.',
